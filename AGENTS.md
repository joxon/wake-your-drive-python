# WakeTheDrive — Agent Reference (AGENTS.md)

This document is the authoritative guide for AI agents working on the WakeTheDrive codebase. Read it before making any changes.
